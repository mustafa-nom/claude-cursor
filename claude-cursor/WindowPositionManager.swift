...
class WindowPositionManager {
    ...
    private static let hasPreviouslyConfirmedScreenRecordingPermissionUserDefaultsKey = "com.claudecursor.hasPreviouslyConfirmedScreenRecordingPermission"
    private static let legacyHasPreviouslyConfirmedScreenRecordingPermissionUserDefaultsKey = "com.learningbuddy.hasPreviouslyConfirmedScreenRecordingPermission"

    private static func hasPreviouslyConfirmedScreenRecordingPermissionFromUserDefaults() -> Bool {
        if UserDefaults.standard.bool(forKey: hasPreviouslyConfirmedScreenRecordingPermissionUserDefaultsKey) {
            return true
        }
        if UserDefaults.standard.bool(forKey: legacyHasPreviouslyConfirmedScreenRecordingPermissionUserDefaultsKey) {
            UserDefaults.standard.set(true, forKey: hasPreviouslyConfirmedScreenRecordingPermissionUserDefaultsKey)
            UserDefaults.standard.removeObject(forKey: legacyHasPreviouslyConfirmedScreenRecordingPermissionUserDefaultsKey)
            return true
        }
        return false
    }
    ...
    static func shouldTreatScreenRecordingPermissionAsGrantedForSessionLaunch() -> Bool {
        shouldTreatScreenRecordingPermissionAsGrantedForSessionLaunch(
            ...
            hasPreviouslyConfirmedScreenRecordingPermission: hasPreviouslyConfirmedScreenRecordingPermissionFromUserDefaults()
        )
    }
