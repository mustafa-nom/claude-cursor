...
final class AssemblyAIStreamingTranscriptionProvider: BuddyTranscriptionProvider {
    ...
    private static let tokenProxyURL = "https://cc-proxy.musnom.workers.dev/transcribe-token"
...
private final class AssemblyAIStreamingTranscriptionSession: NSObject, BuddyStreamingTranscriptionSession {
    ...
    private let stateQueue = DispatchQueue(label: "com.claudecursor.assemblyai.state")
    private let sendQueue = DispatchQueue(label: "com.claudecursor.assemblyai.send")
