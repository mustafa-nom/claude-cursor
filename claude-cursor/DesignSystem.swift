...
//  claude-cursor
//
//  Centralized design system using a terracotta accent palette on dark surfaces,
...
enum DS {
    ...
    enum Colors {
        ...
        /// Text used on top of the accent fill (#D4724A), like the primary button label.
        /// White on this terracotta achieves strong contrast on dark UI.
        static let textOnAccent: Color = .white

        // ── Brand terracotta scale (cursor SVG fill #D4724A at 600) ──
        //
        // Usage guide:
        ...
        //   400     → Bright accent text, links, icons
        ...
        //   800–900 → Deep fills (e.g. chat bubbles), dark overlays
        //   950     → Deepest rust — near-black tinted backgrounds

        static let brand50  = Color(hex: "#FFF5F2")
        static let brand100 = Color(hex: "#FFE8DF")
        static let brand200 = Color(hex: "#FFD0C2")
        static let brand300 = Color(hex: "#FFB399")
        static let brand400 = Color(hex: "#E8957A")
        static let brand500 = Color(hex: "#D9835F")
        static let brand600 = Color(hex: "#D4724A")
        static let brand700 = Color(hex: "#B85C3A")
        static let brand800 = Color(hex: "#8F4329")
        static let brand900 = Color(hex: "#6D3320")
        static let brand950 = Color(hex: "#3D1C12")

        // ── Accent (derived from brand scale) ──────────────────────

        /// Accent fill — used for solid button backgrounds.
        static let accent = brand600

        /// Accent hover — darker terracotta for hover state.
        static let accentHover = brand700

        /// Accent text — bright terracotta for text and icons on dark backgrounds.
        ...
        /// Independent green so success states are visually distinct from the terracotta accent.
        ...
        /// Info/feature highlight — warm peach, distinct from interactive accent fills.
        static let info = Color(hex: "#F4A77A")

        /// Inline code text color — light terracotta for monospace on dark surfaces.
        static let codeText = Color(hex: "#FFC4A8")

        // ── Overlay companion cursor ─────────────────────────────────

        /// Cursor glyph, overlay bubbles, and consent UI — matches SVG fill #D4724A.
        static let overlayCursorBrand = Color(hex: "#D4724A")

        // ── Explainer Multi-Cursor Colors ────────────────────────────

        /// Priority-mapped colors for the `explain_screen_elements` multi-cursor
        /// overlay. Critical = warm, important = cool-bright, helpful = green.
        /// The main cursor's brand orange is intentionally excluded.
        static let explainerCursorColors: [Color] = [
            Color(hex: "#E74C3C"),  // critical: red
            Color(hex: "#E67E22"),  // critical: amber
            Color(hex: "#8E44AD"),  // important: purple
            Color(hex: "#2980B9"),  // important: blue
            Color(hex: "#3498DB"),  // important: sky
            Color(hex: "#1ABC9C"),  // helpful: teal
            Color(hex: "#2ECC71"),  // helpful: green
            Color(hex: "#27AE60"),  // helpful: forest
        ]
        ...
        /// User message bubble background in the help chat — deep rust, readable white text.
        static let helpChatUserBubble = brand800

        /// Slightly lighter variant for hover/pressed states on user bubbles.
        static let helpChatUserBubbleHover = brand700
