...
enum ClaudeCursorAnalytics {
    ...
    /// The 40s onboarding demo interaction where ClaudeCursor points at something.
    ...
    /// Claude called the `point_at_element` tool, so the buddy is flying
